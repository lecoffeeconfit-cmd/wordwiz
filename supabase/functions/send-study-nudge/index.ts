...
const NUDGE_MESSAGES: Record<string, { nudgeType: string; title: string }> = {
  ...
  pearl_gold_cheer: { nudgeType: 'encouragement', title: '🤍💛 Cheering for your next word' },
  ...
  pearl_gold_review: { nudgeType: 'study_reminder', title: '🤍💛 A little review magic for you' },
  leaderboard_spot: { nudgeType: 'five_word_challenge', title: '🏆 I’m coming for your leaderboard spot' },
  ...
  pearl_gold_race: { nudgeType: 'five_word_challenge', title: '🤍💛 Friendly race to the next word' },
  ...
  pearl_gold_challenge: { nudgeType: 'five_word_challenge', title: '🤍💛 A five-minute word challenge for us' },
  ...
  pearl_gold_proud: { nudgeType: 'encouragement', title: '🤍💛 So proud of your word power' },
  ...
  pearl_gold_return: { nudgeType: 'encouragement', title: '🤍💛 Your words will be here when you’re ready' },
  ...
  pearl_gold_owl: { nudgeType: 'study_reminder', title: '🤍💛 The WordWiz owl sent you a shiny heart' },
};
